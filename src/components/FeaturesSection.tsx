          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="mb-4 transition-transform duration-300 group-hover:scale-110">
                <div className={`w-12 h-12 rounded-xl backdrop-blur-2xl ${feature.bg} border ${feature.border} flex items-center justify-center group-hover:box-glow-sm transition-all duration-300`}>
