  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        "يمكن لقصي الاطلاع على المحادثات لأغراض تحسين الخدمة ومراقبة الأداء",
        "يتم ربط المحادثات بحسابك (الاسم والبريد الإلكتروني) عند تسجيل الدخول",
        "المحادثات غير المسجّل صاحبها تظهر كـ'مجهول' في سجلات قصي",
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        "قصي فقط يمكنه الاطلاع على بيانات الحسابات ومحادثات AI لأغراض إدارية",
        "قصي لديه صلاحيات إدارة الحسابات بما في ذلك إزالة المستخدمين عند الضرورة",
    ...
    },
    {
      ...
      content: [
        ...
        "يمكنك طلب حذف حسابك وجميع بياناتك بالتواصل مع قصي",
