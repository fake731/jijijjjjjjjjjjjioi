...
const tools: Tool[] = [
  ...
  },
  {
    ...
    commands: [
      { command: "git clone https://github.com/techchipnet/CamPhish", description: { ar: "استنساخ المستودع الرسمي من GitHub", en: "Clone official repository from GitHub" } },
      { command: "cd CamPhish", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "apt install php curl -y", description: { ar: "تثبيت PHP و curl المطلوبين لتشغيل السيرفر", en: "Install required PHP and curl for server" } },
      { command: "bash camphish.sh", description: { ar: "تشغيل سكربت الأداة الرئيسي", en: "Run main tool script" } },
    ],
  },
  {
    name: "HiddenEye",
    ...
    commands: [
      { command: "git clone https://github.com/DarkSecDevelopers/HiddenEye-Legacy", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd HiddenEye-Legacy", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "pip3 install -r requirements.txt", description: { ar: "تثبيت مكتبات Python المطلوبة", en: "Install required Python libraries" } },
      { command: "python3 HiddenEye.py", description: { ar: "تشغيل الأداة", en: "Run the tool" } },
    ],
  },
  {
    name: "Seeker",
    ...
    commands: [
      { command: "git clone https://github.com/thewhiteh4t/seeker", description: { ar: "استنساخ المستودع الرسمي من GitHub", en: "Clone official repository from GitHub" } },
      { command: "cd seeker", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "chmod +x install.sh && ./install.sh", description: { ar: "إعطاء صلاحية التنفيذ وتشغيل سكربت التثبيت", en: "Make executable and run install script" } },
      { command: "python3 seeker.py", description: { ar: "تشغيل الأداة", en: "Run the tool" } },
    ],
  },
  {
    name: "SocialFish",
    ...
    commands: [
      { command: "git clone https://github.com/UndeadSec/SocialFish", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd SocialFish", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "pip3 install -r requirements.txt", description: { ar: "تثبيت المكتبات المطلوبة من ملف requirements", en: "Install required libraries from requirements file" } },
      { command: "python3 SocialFish.py", description: { ar: "تشغيل الأداة وفتح لوحة التحكم", en: "Run tool and open dashboard" } },
    ],
  },
  {
    name: "Hound",
    ...
    commands: [
      { command: "git clone https://github.com/techchipnet/Hound", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd Hound", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "chmod +x hound.sh", description: { ar: "إعطاء صلاحية التنفيذ للسكربت", en: "Make script executable" } },
      { command: "bash hound.sh", description: { ar: "تشغيل الأداة", en: "Run the tool" } },
    ],
  },
  {
    name: "PhoneInfoga",
    ...
    commands: [
      { command: "git clone https://github.com/sundowndev/phoneinfoga", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd phoneinfoga", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "go build -o phoneinfoga .", description: { ar: "بناء الأداة باستخدام Go", en: "Build tool using Go" } },
      { command: "./phoneinfoga scan -n +1234567890", description: { ar: "فحص رقم هاتف", en: "Scan a phone number" } },
    ],
  },
  {
    name: "Sherlock",
    ...
    commands: [
      { command: "git clone https://github.com/sherlock-project/sherlock", description: { ar: "استنساخ المستودع الرسمي من GitHub", en: "Clone official repository from GitHub" } },
      { command: "cd sherlock", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "pip3 install -r requirements.txt", description: { ar: "تثبيت جميع المكتبات المطلوبة", en: "Install all required libraries" } },
      { command: "python3 sherlock username", description: { ar: "البحث عن اسم مستخدم عبر المنصات", en: "Search username across platforms" } },
    ],
  },
  {
    name: "SpiderFoot",
    ...
    commands: [
      { command: "git clone https://github.com/smicallef/spiderfoot", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd spiderfoot", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "pip3 install -r requirements.txt", description: { ar: "تثبيت المكتبات المطلوبة", en: "Install required libraries" } },
      { command: "python3 sf.py -l 127.0.0.1:5001", description: { ar: "تشغيل واجهة الويب على المنفذ 5001", en: "Run web interface on port 5001" } },
    ],
  },
  {
    name: "ReconDog",
    ...
    commands: [
      { command: "git clone https://github.com/s0md3v/ReconDog", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd ReconDog", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "python3 dog.py", description: { ar: "تشغيل الأداة واختيار نوع الفحص", en: "Run tool and select scan type" } },
    ],
  },
  {
    name: "Ghost Phisher",
    ...
    commands: [
      { command: "sudo apt install ghost-phisher -y", description: { ar: "تثبيت الأداة من مستودعات Kali الرسمية", en: "Install from official Kali repositories" } },
      { command: "ghost-phisher", description: { ar: "تشغيل الأداة (يتطلب صلاحيات root)", en: "Run tool (requires root)" } },
    ],
  },
  {
    name: "Zphisher",
    description: { ar: "أداة تصيد احترافية تدعم 30+ منصة", en: "Professional phishing tool supporting 30+ platforms" },
    commands: [
      { command: "git clone https://github.com/htr-tech/zphisher", description: { ar: "استنساخ المستودع الرسمي من GitHub", en: "Clone official repository from GitHub" } },
      { command: "cd zphisher", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "chmod +x zphisher.sh", description: { ar: "إعطاء صلاحية التنفيذ للسكربت", en: "Make script executable" } },
      { command: "bash zphisher.sh", description: { ar: "تشغيل الأداة واختيار المنصة المستهدفة", en: "Run tool and select target platform" } },
    ],
  },
  {
    name: "BlackEye",
    description: { ar: "أداة تصيد بسيطة وفعالة", en: "Simple and effective phishing tool" },
    commands: [
      { command: "git clone https://github.com/An0nUD4Y/blackeye", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd blackeye", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "bash blackeye.sh", description: { ar: "تشغيل الأداة", en: "Run the tool" } },
    ],
  },
  {
    name: "Osintgram",
    description: { ar: "أداة OSINT لجمع معلومات من انستغرام", en: "OSINT tool for Instagram information gathering" },
    commands: [
      { command: "git clone https://github.com/Datalux/Osintgram", description: { ar: "استنساخ المستودع الرسمي", en: "Clone official repository" } },
      { command: "cd Osintgram", description: { ar: "الدخول لمجلد الأداة", en: "Enter tool directory" } },
      { command: "pip3 install -r requirements.txt", description: { ar: "تثبيت المكتبات المطلوبة", en: "Install required libraries" } },
